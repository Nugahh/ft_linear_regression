...
print(mileages)
# Store original mileages for later prediction use if needed
original_mileages = mileages.copy()
...
learning_rate = 0.0000000001  # Try this
theta0 = 0
theta1 = 0
...
with open('model.json', 'w') as f:
	json.dump({'theta0': theta0, 'theta1': theta1, 'max_mileage': max_mileage}, f)
